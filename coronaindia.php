...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-lg nav_style p-3">
        <a class="navbar-brand pl-5" href="#">Indian covid-meter</a>
    ...
    <section class="corona_update container-fluid" id="home">
        <div class="mb-5">
            <h3 class="text-uppercase text-center">Covid-19 Updates Indian State-wise</h3>
            <hr>
        </div>
            ...
            <table class="table table-bordered table-striped text-center" id="tbval">
                <tr>
                    ...
                    <th class="text-capitalize confirmed">Total Confirmed<img
                            ...
                            height="30" /></th>
                            <th class="text-capitalize confirmed">Active<img src="https://img.icons8.com/ios-filled/50/000000/patient-oxygen-mask.png"
                        width="30" height="30" /></th>
                    <th class="text-capitalize recovered">Total Recovered <img
                            src="https://img.icons8.com/offices/30/000000/aed.png" width="30" height="30" /></th>
                    <th class="text-capitalize dead">Total Deaths <img
                            src="https://img.icons8.com/pastel-glyph/64/000000/crossbones.png" height="30" width="30" />
                    </th>
...
$statecountcount= count($coronalive['statewise']);
$i=1;
while($i < $statecountcount){
     ?>
                <tr>
